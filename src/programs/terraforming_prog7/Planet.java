...
public class Planet {
    ...
    public Planet(String n, int size, int waterPercentage, int plantPercentage, int mineralPercentage, int animalPercentage) {
        name = n;
        totalTerraObjects = 0;
        totalImpactScore = 0;
        ...
        if (size == 1)
            ...
            maxSize = rand.nextInt(5000 - 1501 + 1) + 1501;
